...
public class RsrcURLStreamHandlerFactory implements URLStreamHandlerFactory {
	 ...
	 * URL.setURLStreamHandlerFactory does not allow multiple factories to be
	 * added. The chained factory is called for all other protocols, except
	 * "rsrc". Use null to clear previously set Handler.
	 * 
	 * @param fac
	 *            another factory to be chained with ours.
	 */
