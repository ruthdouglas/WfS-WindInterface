 ...
 * 
 * Handle URLs with protocol "rsrc". "rsrc:path/file.ext" identifies the content
 * accessible as classLoader.getResourceAsStream("path/file.ext"). "rsrc:path/"
 * identifies a base-path for resources to be searched. The spec "file.ext" is
 * combined to "rsrc:path/file.ext".
 * 
 * @since 3.5
 */
